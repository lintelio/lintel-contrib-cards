 ...
 * https://github.com/lintelio/lintel-contrib-cards
 *
...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    sass: {
      ...
      dist: {
        files: {
          '<%= lintel.dist %>/cards.css': 'sass/lintel-core-loader.scss'
        }
      }
    },
    ...
    cssmin: {
      ...
      dist: {
        src: '<%= lintel.dist %>/cards.css',
        dest: '<%= lintel.dist %>/cards.min.css'
      }
    },
    ...
    webshot: {
      xs: {
        options: {
          siteType: 'url',
          site: 'http://localhost:4554/cards.html',
